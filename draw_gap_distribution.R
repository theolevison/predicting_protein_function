...
dat_gap <- read.csv(file="E:/Diss/inter_domain_sizes.csv", header=FALSE, check.names=FALSE, strip.white = TRUE, sep=",",na.strings= c("NA", " ", ""))
...
ggsave("D:/diss/gaps_distribution.eps", device="eps", width=10, height=7, dpi=300)