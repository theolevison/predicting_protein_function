pathroot<-"D:/diss/domain_word2vec_scripts/"
if (R.version$os=="darwin13.4.0")     pathroot="D:/diss/domain_word2vec_scripts/"
nn1_accuracy_data <- read.csv(file=paste(pathroot,"nn1_markov_accuracy.csv", sep=""), check.names=FALSE, strip.white = TRUE, sep=",",na.strings= c("NA", " ", ""))
nn3_accuracy_data <- read.csv(file=paste(pathroot,"nn3_markov_accuracy.csv", sep=""), check.names=FALSE, strip.white = TRUE, sep=",",na.strings= c("NA", " ", ""))
nn5_accuracy_data <- read.csv(file=paste(pathroot,"nn5_markov_accuracy.csv", sep=""), check.names=FALSE, strip.white = TRUE, sep=",",na.strings= c("NA", " ", ""))
nn10_accuracy_data <- read.csv(file=paste(pathroot,"nn10_markov_accuracy.csv", sep=""), check.names=FALSE, strip.white = TRUE, sep=",",na.strings= c("NA", " ", ""))
